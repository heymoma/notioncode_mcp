"""Upgrade account files written by older releases, in place and idempotently.

Run by both installers before the service starts. A legacy file keeps its
browser cookie so an existing Notion session does not have to be re-created.
"""
...
from .pool import discover_account_paths
